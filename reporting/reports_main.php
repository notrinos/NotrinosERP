...
$reports->addReport(RC_INVENTORY, 310, _('Inventory Purchasing - &Transaction Based'),
	array(	_('Start Date') => 'DATEBEGINM',
			...
			_('Orientation') => 'ORIENTATION',
			_('Destination') => 'DESTINATION'));
$reports->addReport(RC_INVENTORY, 311, _('&Traceability Report (Forward/Reverse)'),
	array(	_('Trace Direction') => 'TRACE_DIRECTION',
			_('Serial/Batch Number') => 'TEXT',
			_('Comments') => 'TEXTBOX',
			_('Orientation') => 'ORIENTATION',
			_('Destination') => 'DESTINATION'));
$reports->addReport(RC_INVENTORY, 312, _('Recall &Status Report'),
	array(	_('Date From') => 'DATEBEGINM',
			_('Recall Status') => 'RECALL_STATUS',
			_('Severity') => 'RECALL_SEVERITY',
			_('Item') => 'ITEMS_P',
			_('Comments') => 'TEXTBOX',
			_('Orientation') => 'ORIENTATION',
			_('Destination') => 'DESTINATION'));

// --- Plan A: Advanced Item Management Reports (313-322) ---
$reports->addReport(RC_INVENTORY, 313, _('Serial Number &Ledger'),
	array(	_('Start Date') => 'DATEBEGINM',
			_('End Date') => 'DATEENDM',
			_('Item') => 'ITEMS_P',
			_('Location') => 'LOCATIONS',
			...
			_('Orientation') => 'ORIENTATION',
			_('Destination') => 'DESTINATION'));
$reports->addReport(RC_INVENTORY, 314, _('Batch-wise Stock &Balance'),
	array(	_('Item') => 'ITEMS_P',
			_('Location') => 'LOCATIONS',
			_('Category') => 'CATEGORIES',
			_('Comments') => 'TEXTBOX',
			_('Orientation') => 'ORIENTATION',
			_('Destination') => 'DESTINATION'));
$reports->addReport(RC_INVENTORY, 315, _('Batch &Aging Analysis'),
	array(	_('As at Date') => 'DATEENDM',
			_('Item') => 'ITEMS_P',
			_('Location') => 'LOCATIONS',
			_('Category') => 'CATEGORIES',
			_('Comments') => 'TEXTBOX',
			_('Orientation') => 'ORIENTATION',
			_('Destination') => 'DESTINATION'));
$reports->addReport(RC_INVENTORY, 316, _('&Expiry Report'),
	array(	_('As at Date') => 'DATEENDM',
			_('Days to Expiry') => 'TEXT',
			_('Item') => 'ITEMS_P',
			_('Location') => 'LOCATIONS',
			_('Comments') => 'TEXTBOX',
			_('Orientation') => 'ORIENTATION',
			_('Destination') => 'DESTINATION'));
$reports->addReport(RC_INVENTORY, 317, _('Quality Inspection &Summary'),
	array(	_('Start Date') => 'DATEBEGINM',
			_('End Date') => 'DATEENDM',
			_('Item') => 'ITEMS_P',
			_('Location') => 'LOCATIONS',
			...
			_('Orientation') => 'ORIENTATION',
			_('Destination') => 'DESTINATION'));
$reports->addReport(RC_INVENTORY, 318, _('&Warranty Claims Summary'),
	array(	_('Start Date') => 'DATEBEGINM',
			_('End Date') => 'DATEENDM',
			_('Item') => 'ITEMS_P',
			_('Comments') => 'TEXTBOX',
			_('Orientation') => 'ORIENTATION',
			_('Destination') => 'DESTINATION'));
$reports->addReport(RC_INVENTORY, 319, _('Serial &Warranty Status'),
	array(	_('Item') => 'ITEMS_P',
			_('Include Expired') => 'YES_NO',
			_('Comments') => 'TEXTBOX',
			_('Orientation') => 'ORIENTATION',
			_('Destination') => 'DESTINATION'));
$reports->addReport(RC_INVENTORY, 320, _('&FEFO Compliance Report'),
	array(	_('As at Date') => 'DATEENDM',
			_('Item') => 'ITEMS_P',
			_('Location') => 'LOCATIONS',
			_('Comments') => 'TEXTBOX',
			_('Orientation') => 'ORIENTATION',
			_('Destination') => 'DESTINATION'));
$reports->addReport(RC_INVENTORY, 321, _('Serial Cos&t Report'),
	array(	_('Item') => 'ITEMS_P',
			_('Location') => 'LOCATIONS',
			_('Category') => 'CATEGORIES',
			_('Comments') => 'TEXTBOX',
			_('Orientation') => 'ORIENTATION',
			_('Destination') => 'DESTINATION'));
$reports->addReport(RC_INVENTORY, 322, _('Supplier &Quality Report'),
	array(	_('Start Date') => 'DATEBEGINM',
			_('End Date') => 'DATEENDM',
			_('Supplier') => 'SUPPLIERS_NO_FILTER',
			_('Comments') => 'TEXTBOX',
...
// --- Plan B: Warehouse / Location Reports (350-358) ---
$reports->addReport(RC_INVENTORY, 350, _('&Bin Contents Report'),
	array(	_('Location') => 'LOCATIONS',
			_('Bin Code') => 'TEXT',
			_('Item') => 'ITEMS_P',
			_('Comments') => 'TEXTBOX',
			_('Orientation') => 'ORIENTATION',
			_('Destination') => 'DESTINATION'));
$reports->addReport(RC_INVENTORY, 351, _('Stock by &Location'),
	array(	_('Location') => 'LOCATIONS',
			_('Category') => 'CATEGORIES',
			_('Comments') => 'TEXTBOX',
			_('Orientation') => 'ORIENTATION',
			_('Destination') => 'DESTINATION'));
$reports->addReport(RC_INVENTORY, 352, _('Bin-Level Mo&vement Ledger'),
	array(	_('Start Date') => 'DATEBEGINM',
			_('End Date') => 'DATEENDM',
			_('Location') => 'LOCATIONS',
			_('Bin Code') => 'TEXT',
			...
			_('Orientation') => 'ORIENTATION',
			_('Destination') => 'DESTINATION'));
$reports->addReport(RC_INVENTORY, 353, _('Stock Aging by &Bin'),
	array(	_('As at Date') => 'DATEENDM',
			_('Location') => 'LOCATIONS',
			_('Category') => 'CATEGORIES',
			_('Comments') => 'TEXTBOX',
			_('Orientation') => 'ORIENTATION',
			_('Destination') => 'DESTINATION'));
$reports->addReport(RC_INVENTORY, 354, _('&Dead Stock Report'),
	array(	_('End Date') => 'DATEENDM',
			_('Days Without Movement') => 'TEXT',
			_('Location') => 'LOCATIONS',
			_('Category') => 'CATEGORIES',
			_('Comments') => 'TEXTBOX',
			_('Orientation') => 'ORIENTATION',
			_('Destination') => 'DESTINATION'));
$reports->addReport(RC_INVENTORY, 355, _('Warehouse &Utilization'),
	array(	_('Location') => 'LOCATIONS',
			_('Comments') => 'TEXTBOX',
			_('Orientation') => 'ORIENTATION',
			_('Destination') => 'DESTINATION'));
$reports->addReport(RC_INVENTORY, 356, _('Inventory &Turn Rate'),
	array(	_('Start Date') => 'DATEBEGINM',
			_('End Date') => 'DATEENDM',
			_('Location') => 'LOCATIONS',
			_('Category') => 'CATEGORIES',
			...
			_('Orientation') => 'ORIENTATION',
			_('Destination') => 'DESTINATION'));
$reports->addReport(RC_INVENTORY, 357, _('Transfer &Order Status'),
	array(	_('Start Date') => 'DATEBEGINM',
			_('End Date') => 'DATEENDM',
			_('Status') => 'TRANSFER_STATUS',
			_('Comments') => 'TEXTBOX',
			_('Orientation') => 'ORIENTATION',
			_('Destination') => 'DESTINATION'));
$reports->addReport(RC_INVENTORY, 358, _('Cycle Count &Accuracy'),
	array(	_('Start Date') => 'DATEBEGINM',
			_('End Date') => 'DATEENDM',
			_('Location') => 'LOCATIONS',
			_('Comments') => 'TEXTBOX',
