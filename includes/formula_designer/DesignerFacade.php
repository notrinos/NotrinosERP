...
class DesignerFacade
{
    ...
    private static function getBuiltInFieldDefinitions()
    {
        return array(
            ...
            array('module' => 'hrm', 'namespace' => 'Employee', 'name' => 'BankAccount', 'label' => 'Bank Account', 'type' => 'text', 'description' => 'Employee bank account.', 'requiredPermission' => 'SA_DENIED'),
            array('module' => 'hrm', 'namespace' => 'Employee', 'name' => 'TaxId', 'label' => 'Tax ID', 'type' => 'text', 'description' => 'Employee tax identifier.', 'requiredPermission' => 'SA_DENIED'),
    ...
    private static function injectModalStyles()
    {
        ...
        $css = '.fd-modal-overlay {'
            ...
            . '.fd-modal-panel {'
            . 'background:#fff; border-radius:8px; width:95vw;'
            . 'max-width:1300px; max-height:95vh; overflow:auto;'
            . 'box-shadow:0 20px 60px rgba(0,0,0,0.25); display:flex;'
            . 'flex-direction:column; margin:10px 0; }'
            . '@media (min-width:768px) {'
            . '.fd-modal-overlay { padding:20px 0; }'
            . '.fd-modal-panel { width:90vw; max-height:90vh; }'
            . '}'
            . '@media (min-width:1024px) {'
            . '.fd-modal-overlay { padding-top:40px; }'
            . '.fd-modal-panel { width:85vw; }'
            . '}'
            . '.fd-modal-header {'
