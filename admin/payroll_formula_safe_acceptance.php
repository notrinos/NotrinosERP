...
if (!isset($db_version) || (string)$db_version !== '1.0.470')
    pr2_accept_cli_exit(false, 'source_version_not_1_0_470');
...
if ($company_version !== '1.0.470')
    pr2_accept_cli_exit(false, 'company_version_not_1_0_470', array('company_version'=>$company_version));
