...
if ($is_cli) {
    ...
    if ($email_summary !== null) {
        ...
        echo "  Transport SMTP Connect Failed: " . $email_summary['transport_smtp_connect_failed'] . "\n";
...
if ($run_emails || isset($_POST['RunBoth'])) {
    ...
    if ($email_summary !== null) {
        ...
        label_row(_('Transport SMTP Connect Failed'), $email_summary['transport_smtp_connect_failed']);
