...
class HrmApp extends application {
	function __construct() {
		...
		$this->add_rapp_function(2, _('Lea&ve Types'), '/hrm/manage/leave_types.php?', 'SA_LEAVETYPE', MENU_MAINTENANCE);
		$this->add_rapp_function(2, _('Pay Ele&ments'), '/hrm/manage/overtime.php?', 'SA_PAYELEMENT', MENU_SETTINGS);
