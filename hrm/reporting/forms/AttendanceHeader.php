...
page(_("Attendance Report Header"));

start_table(TABLESTYLE2, "width='60%'");
label_row(_('Header Type:'), _('Attendance Report'));
...
display_note(_('This page previews parameter values passed to attendance reports.'), 0, 1);
